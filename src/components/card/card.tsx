...
import { monitorRiwayatUser, deleteRiwayat } from "@/lib/firebase/transaksi";

export default function CardComponent({ data }: { data: typeRiwayat[] }) {
  const [setDataRiwayatKeluar, setDataRiwayatMasuk ,clearRiwayatTerbaruAndsemuaRiwayat] = useStore(
    useShallow((state:any) => [state.setDataRiwayatKeluar, state.setDataRiwayatMasuk ,state.clearRiwayatTerbaruAndsemuaRiwayat])
  );
  // console.log(data);
